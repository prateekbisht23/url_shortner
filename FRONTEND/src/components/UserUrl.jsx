...
const UserUrls = () => {
        ...
        return (
            <div className='flex justify-center my-8'>
                <div className='animate-spin rounded-full h-32 w-32 border-t-2 border-b-2 border-gray-200'>
                    <svg className="w-10 h-10 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
                </div>
            </div>
        )
    }
    ...
    if (isError) {
        return (
            <div className='flex justify-center my-8 border border-red-500 rounded-lg p-4 bg-red-50 text-red-600'>
                        ...
                        {urls.urls.reverse().map((url) => (
                            <tr key={url._id} className="hover:bg-gray-50">
                                <td className="px-6 py-4">
                                    <div className="text-sm text-gray-900 truncate max-w-52">
                                        {url.full_url}
                                    </div>
                                </td>
                                <td className="px-6 py-4">
